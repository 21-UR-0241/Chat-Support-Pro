...
//     position:fixed; bottom:82px; left:20px; z-index:99990;
//     background:#fff; color:#111827; border:1.5px solid #e5e7eb; border-radius:24px;
//     padding:10px 18px 10px 14px; font-size:clamp(11px,1.8vw,13px); font-weight:600; cursor:pointer;
//     display:flex; align-items:center; gap:8px; white-space:nowrap;
//     font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;
//     box-shadow:0 2px 14px rgba(0,0,0,.10),0 1px 3px rgba(0,0,0,.06);
//     transition:box-shadow .18s,transform .12s,border-color .18s,opacity .2s;
...
//   /* ── Modal ── */
//   #psk-modal {
//     background:#fff; border-radius:clamp(16px,2.5vw,24px);
//     width:100%; max-width:min(520px, 100%);
//     max-height:min(92dvh, 92vh);
//     overflow-y:auto;
//     padding:clamp(20px, 4vw, 36px) clamp(16px, 4vw, 32px) clamp(20px, 3vw, 30px);
//     position:relative;
//     animation:psk-slideup .3s cubic-bezier(.22,1,.36,1);
//     font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif; color:#111827;
//     box-shadow:0 24px 64px rgba(0,0,0,.16),0 4px 16px rgba(0,0,0,.08);
...
//     box-sizing:border-box;
//   }
//   #psk-modal::-webkit-scrollbar { width:5px; }
//   #psk-modal::-webkit-scrollbar-track { background:transparent; }
//   #psk-modal::-webkit-scrollbar-thumb { background:#e5e7eb; border-radius:99px; }
//   @keyframes psk-slideup {
//     from{opacity:0;transform:translateY(20px) scale(.97)}
//     to{opacity:1;transform:translateY(0) scale(1)}
//   }
...
//   .psk-close {
//     position:absolute; top:clamp(12px,2vw,16px); right:clamp(12px,2vw,16px);
//     background:#f3f4f6; border:none; border-radius:50%;
//     width:32px; height:32px; display:flex; align-items:center; justify-content:center;
//     cursor:pointer; color:#6b7280; font-size:15px; transition:background .14s,color .14s;
//     flex-shrink:0;
...
//   /* ── Logo row ── */
//   .psk-logo-row { display:flex; align-items:center; gap:10px; margin-bottom:clamp(12px,2vw,16px); }
//   .psk-logo-icon {
//     width:clamp(30px,5vw,36px); height:clamp(30px,5vw,36px);
//     background:linear-gradient(135deg,#f0fdf4,#dcfce7);
//     border:1.5px solid #bbf7d0; border-radius:10px;
//     display:flex; align-items:center; justify-content:center;
//     font-size:clamp(15px,3vw,18px); flex-shrink:0;
//   }
//   .psk-logo-text { font-size:clamp(12px,2vw,14px); font-weight:800; color:#111827; letter-spacing:-.2px; }
//   .psk-logo-sub  { font-size:clamp(9px,1.5vw,10px); font-weight:500; color:#6b7280; letter-spacing:.3px; text-transform:uppercase; }

//   /* ── Typography ── */
//   .psk-heading {
//     font-size:clamp(17px,4vw,22px); font-weight:800; color:#111827;
//     margin:0 0 6px; line-height:1.2; letter-spacing:-.3px;
//   }
//   .psk-sub {
//     font-size:clamp(12px,2vw,13.5px); color:#6b7280;
//     margin:0 0 clamp(16px,3vw,24px); line-height:1.55;
//   }

//   /* ── Divider labels ── */
//   .psk-divider-label {
//     font-size:clamp(9.5px,1.6vw,10.5px); font-weight:700; letter-spacing:.7px; text-transform:uppercase;
//     color:#9ca3af; margin:clamp(14px,2.5vw,20px) 0 clamp(8px,1.5vw,12px);
//     display:flex; align-items:center; gap:8px;
//   }
//   .psk-divider-label::after { content:''; flex:1; height:1px; background:#f3f4f6; }

//   /* ── Fields ── */
//   .psk-field { margin-bottom:clamp(10px,1.8vw,13px); }
//   .psk-field label {
//     display:block; font-size:clamp(9.5px,1.6vw,11px); font-weight:700;
//     letter-spacing:.6px; text-transform:uppercase; color:#9ca3af; margin-bottom:5px;
//   }
//   .psk-field input, .psk-field select, .psk-field textarea {
//     width:100%; background:#f9fafb; border:1.5px solid #e5e7eb; border-radius:10px;
//     padding:clamp(10px,1.8vw,11px) clamp(12px,2vw,14px);
//     font-size:clamp(13px,2.2vw,14px); color:#111827; outline:none; box-sizing:border-box;
//     font-family:inherit; transition:border-color .15s,box-shadow .15s,background .15s;
//     -webkit-appearance:none; appearance:none;
//   }
//   .psk-field input::placeholder, .psk-field textarea::placeholder { color:#d1d5db; }
...
//   /* ── Chips ── */
//   .psk-chips { display:flex; flex-wrap:wrap; gap:clamp(5px,1vw,7px); }
//   .psk-chip {
//     background:#f9fafb; border:1.5px solid #e5e7eb; border-radius:99px;
//     padding:clamp(6px,1.2vw,7px) clamp(11px,2vw,14px);
//     font-size:clamp(11.5px,1.9vw,12.5px); font-weight:500; color:#374151;
//     cursor:pointer; transition:all .14s; user-select:none;
//   }
//   .psk-chip:hover { border-color:#3bbe28; color:#166534; background:#f0fdf4; }
//   .psk-chip.psk-sel { background:#f0fdf4; border-color:#3bbe28; color:#166534; font-weight:700; box-shadow:0 0 0 3px rgba(59,190,40,.10); }
...
//   .psk-custom-toggle {
//     display:flex; align-items:center; gap:6px; cursor:pointer;
//     font-size:clamp(10px,1.6vw,11px); font-weight:700; letter-spacing:.6px; text-transform:uppercase;
//     color:#9ca3af; user-select:none;
//   }
//   .psk-custom-toggle span { font-size:10px; transition:transform .2s; display:inline-block; }
//   .psk-custom-toggle span.open { transform:rotate(180deg); }
...
//   .psk-btn-primary {
//     width:100%; background:#3bbe28; border:none; border-radius:12px;
//     padding:clamp(12px,2vw,14px); font-size:clamp(13px,2.2vw,15px);
//     font-weight:700; color:#fff; cursor:pointer;
//     transition:background .16s,transform .1s,box-shadow .16s;
//     margin-top:clamp(14px,2.5vw,22px); font-family:inherit;
...
//   .psk-or {
//     display:flex; align-items:center; gap:12px;
//     margin:clamp(10px,2vw,16px) 0 clamp(10px,2vw,13px);
...
//   .psk-btn-scan {
//     width:100%; background:#f9fafb; border:1.5px solid #e5e7eb; border-radius:12px;
//     padding:clamp(11px,2vw,12px) 14px; font-size:clamp(12px,2vw,13px);
//     font-weight:600; color:#374151; cursor:pointer;
//     transition:border-color .14s,color .14s,background .14s;
//     display:flex; align-items:center; justify-content:center;
//     gap:8px; font-family:inherit; text-decoration:none;
...
//   .psk-result-intro {
//     background:#f0fdf4; border:1.5px solid #bbf7d0; border-radius:12px;
//     padding:clamp(12px,2vw,15px) clamp(13px,2.2vw,17px);
//     font-size:clamp(12.5px,2vw,13.5px); line-height:1.7; color:#166534; margin-bottom:18px;
//   }
//   .psk-stack-label {
//     font-size:10.5px; font-weight:700; letter-spacing:.7px; text-transform:uppercase;
...
//   .psk-card:hover { border-color:#bbf7d0; box-shadow:0 4px 12px rgba(59,190,40,.08); }
//   .psk-card-num {
//     width:27px; height:27px; background:#3bbe28; border-radius:50%;
//     display:flex; align-items:center; justify-content:center;
//     font-size:12px; font-weight:800; color:#fff; flex-shrink:0; margin-top:1px;
//     box-shadow:0 2px 6px rgba(59,190,40,.28);
//   }
//   .psk-card-body { flex:1; min-width:0; }
//   .psk-card-name { font-size:clamp(13px,2.2vw,14px); font-weight:800; color:#111827; margin:0 0 4px; }
//   .psk-card-why  { font-size:clamp(12px,1.9vw,12.5px); color:#4b5563; line-height:1.6; margin:0 0 6px; }
//   .psk-card-dose {
//     display:inline-flex; align-items:center; gap:4px;
...
//     font-size:clamp(12px,1.9vw,12.5px); line-height:1.65; color:#78350f;
...
//     font-size:clamp(12px,1.9vw,12.5px); line-height:1.6; color:#991b1b;
//     margin-bottom:12px; display:flex; gap:9px; align-items:flex-start;
//   }
//   .psk-disclaimer {
//     font-size:clamp(10px,1.7vw,11px); color:#9ca3af; line-height:1.6;
//     padding-top:13px; border-top:1px solid #f3f4f6; margin-bottom:13px;
//   }
//   .psk-btn-reset {
//     background:transparent; border:1.5px solid #e5e7eb; border-radius:9px;
//     padding:8px 16px; font-size:12px; color:#6b7280; cursor:pointer;
...
//   .psk-error {
//     display:none; background:#fef2f2; border:1.5px solid #fecaca; border-radius:10px;
//     padding:12px 15px; font-size:13px; color:#dc2626; margin-top:12px; line-height:1.5;
//   }
//   .psk-error.show { display:block; }

//   .psk-steps { display:flex; gap:5px; margin-bottom:clamp(18px,3vw,26px); }
//   .psk-step-pill { height:3px; flex:1; border-radius:99px; background:#f3f4f6; transition:background .35s; }
//   .psk-step-pill.active { background:#3bbe28; }
...
//     height:min(90dvh, 90vh); max-height:860px; position:relative; overflow:hidden;
//     box-shadow:0 28px 72px rgba(0,0,0,.22),0 4px 16px rgba(0,0,0,.10);
//     animation:psk-slideup .3s cubic-bezier(.22,1,.36,1);
//     display:flex; flex-direction:column;
//   }
...
//     padding:clamp(10px,2vw,14px) clamp(14px,2.5vw,18px) clamp(10px,2vw,14px) clamp(14px,2.5vw,20px);
//     border-bottom:1.5px solid #f3f4f6; flex-shrink:0; background:#fff; border-radius:22px 22px 0 0;
//   }
//   #psk-scan-header .psk-logo-icon { width:32px; height:32px; font-size:16px; flex-shrink:0; }
//   #psk-scan-header-title { flex:1; }
//   #psk-scan-header-title strong { font-size:clamp(12px,2vw,13.5px); font-weight:800; color:#111827; display:block; letter-spacing:-.1px; }
//   #psk-scan-header-title span { font-size:clamp(10px,1.6vw,11px); color:#9ca3af; font-weight:500; }
//   #psk-scan-close {
//     background:#f3f4f6; border:none; border-radius:50%;
//     width:32px; height:32px; display:flex; align-items:center; justify-content:center;
//     cursor:pointer; color:#6b7280; font-size:15px; transition:background .14s,color .14s; flex-shrink:0;
...
//   /* ────────────────────────────────────────────
//      RESPONSIVE TIERS
//      480px  = small phone (landscape / SE)
//      360px  = very small phone
//      ──────────────────────────────────────────── */

//   /* ── Small phones (≤ 540px) — bottom sheet ── */
//   @media (max-width:540px) {
//     #psk-btn { font-size:12px; padding:9px 13px 9px 11px; bottom:74px; left:12px; }

//     /* Overlay: align to bottom */
//     #psk-overlay { align-items:flex-end; padding:0; }
...
//     #psk-scan-overlay { padding:0; align-items:stretch; justify-content:stretch; }
//     #psk-scan-modal {
...
//   @media (max-width:360px) {
//     .psk-chip { padding:6px 10px; font-size:11.5px; }
//     .psk-btn-primary { font-size:13.5px; }
//   }

//   /* ── Landscape phones (short + wide) ── */
//   @media (max-height:500px) and (max-width:900px) {
//     #psk-overlay { align-items:center; padding:8px; }
//     #psk-modal {
//       border-radius:16px;
//       max-height:min(98dvh,98vh);
//     }
//     /* Tighten vertical spacing */
//     .psk-logo-row { margin-bottom:8px; }
//     .psk-sub { margin-bottom:10px; }
//     .psk-divider-label { margin:10px 0 8px; }
//     .psk-field { margin-bottom:8px; }
//     .psk-steps { margin-bottom:12px; }
//     .psk-btn-primary { margin-top:12px; padding:11px; }
//     .psk-or { margin:10px 0 8px; }
//   }

//   /* ── Tablet (541px – 900px) — centred card ── */
//   @media (min-width:541px) and (max-width:900px) {
//     #psk-overlay { padding:16px; }
//     #psk-modal { max-width:min(480px,96%); }
//   }

//   /* ── Large screens (> 900px) — more generous spacing ── */
//   @media (min-width:901px) {
//     #psk-modal { max-width:520px; }
//   }
//   `;
//   document.head.appendChild(style);
...
//     var w, h, left, top;
//     if (isMobile) {
//       w = window.screen.availWidth; h = window.screen.availHeight; left = 0; top = 0;
//     } else {
//       w    = Math.min(900, window.screen.availWidth - 40);
//       h    = Math.min(820, window.screen.availHeight - 40);
//       left = Math.round((window.screen.availWidth  - w) / 2);
