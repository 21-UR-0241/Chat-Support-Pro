...
//   onTyping,
//   employeeName,
//   // isMobile prop is no longer needed - CSS handles visibility
// }) {
...
//           {/* 
//             ✅ ALWAYS RENDER - CSS handles visibility based on screen size
//             No need for {isMobile &&} conditional
//           */}
//           <button 
...
function ChatWindow({
  ...
  onTyping,
  employeeName,
  onMenuToggle, // Mobile hamburger menu toggle
  // isMobile prop is no longer needed - CSS handles visibility
}) {
  const [messages, setMessages] = useState([]);
  const [loading, setLoading] = useState(true);
