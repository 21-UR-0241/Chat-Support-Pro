...
//       // Use ref so handler always calls the LATEST version
//       ws.onmessage = (event) => {
//         try {
...
//   // Keep ref always pointing to latest handler
...
//   // Polling fallback - fetch new messages every 5s in case WebSocket misses them
//   useEffect(() => {
//     if (!conversation?.id) {
...
//         setMessages(prev => {
//           // Find messages from server that we don't have yet
...
//           // Also replace any temp messages with their confirmed versions
