...
//     }),
//     [discountCode, discountPercent, validDays]
//   );
...
//         <div style="margin-top:6px;font-size:15px;color:#6b7280;">⏰ Valid for <strong>${days} days only</strong></div>
//       </div>`;
...
// </body>
// </html>`;
//   }, [discountCode, discountPercent, validDays, body, bakeGlobals]);

//   const textTemplate = useMemo(() => {
//     const discountText = [
//       `Use code: ${discountCode}`,
//       `${discountPercent}% OFF your next order`,
//       `Valid for ${validDays} days only`,
//     ].join('\n');
...
//     ].join('\n');
//   }, [body, discountCode, discountPercent, validDays, bakeGlobals]);
